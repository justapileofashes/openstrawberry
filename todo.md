...
- [ ] Drive the orchestration graph from the agent runtime. The model and its transitions are complete and tested; nothing constructs a plan or executes one yet.
